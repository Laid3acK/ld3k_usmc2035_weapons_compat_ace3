class CfgPatches
{
    class ld3k_usmc2035_weapons_compat_ace3
    {
        requiredAddons[]=
        {
            ...
            "Weapons_F_USMC2035_Accessories"
        };
        requiredversion=0.1;
        units[]={};
        weapons[]={};
...
class CfgWeapons
{
    ...
    class USMC35_optic_VCOG_base: ItemCore // Trijicon VCOG® 1-8x28 LED Riflescope - MRAD https://www.trijicon.com/products/details/vc18-c-2400003
    {
        ACE_ScopeHeightAboveRail=4.35103; // ACE3 checkScopes.sqf
        ...
        ACE_ScopeAdjust_Vertical[]={0,35};
        ACE_ScopeAdjust_Horizontal[]={-17,17};
        ACE_ScopeAdjust_VerticalIncrement=0.1;
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        class ItemInfo: InventoryOpticsItem_Base_F
        {
            mass=19.7; // 31.5oz (893g), USMC2035 10
        };
    };
